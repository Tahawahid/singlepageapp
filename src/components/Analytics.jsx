...
import Laptop from "../assests/3156627.jpg";
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p>
            ...
            vitae hic praesentium quo rem expedita nulla quibusdam deserunt
            corrupti quas maiores quod amet dolore quis incidunt deleniti, cum
            delectus.
          </p>
